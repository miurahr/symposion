...
class Speaker(models.Model):
    ...
    biography = models.TextField(
        help_text=_("A little bit about you. 100 words or less, please. This "
                    "will be used in print publications so please keep it "
                    "simple, no links or formatting."))
    ...
    invite_email = models.CharField(max_length=200, unique=True, null=True,
                                    db_index=True, verbose_name=_("Invite_email"))
